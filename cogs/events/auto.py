    ...
    async def send_msg_to_adder(self, guild: discord.Guild):
        async for entry in guild.audit_logs(limit=3):
            if entry.action == discord.AuditLogAction.bot_add:
                embed = discord.Embed(
                    description=f"⛓️‍💥 **Thanks for adding me.**\n\n🌐 My default prefix is `+`\n👏 Use the `+help` command to see a list of commands\n⛓️‍💥 For detailed guides, FAQ and information, visit our **[Support Server](https://discord.gg/X9NDdMf3xf)**",
                    color=0xff0000
                )
                ...
                website_button = Button(label='Website', style=discord.ButtonStyle.link, url='https://discord.gg/X9NDdMf3xf')
                support_button = Button(label='Support', style=discord.ButtonStyle.link, url='https://discord.gg/X9NDdMf3xf')
