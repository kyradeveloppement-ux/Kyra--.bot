...
class Stats(commands.Cog):
    def __init__(self, bot):
        ...
        # Vérifie que le dossier db existe
    ...
    async def stats(self, ctx):
        ...
        embed.add_field(
            name=" Codebase Stats",
            value=f"Total Python Files: **{total_files}**\nTotal Lines: **{total_lines}**\nTotal Words: **{total_words}**",
            inline=False,
        )
        embed.add_field(
            name="🎧 Music Stats",
        ...
        async def system_button_callback(interaction):
            if interaction.user == ctx.author:
                ...
                system_embed.add_field(
                    name="🎴 Memory Info",
                    value=f"• Total Memory: **{memory_info.total / (1024 ** 2):,.2f} MB**\n"
                ...
                system_embed.add_field(
                    name=" CPU Info",
                    value=f"• CPU: **{psutil.cpu_freq().max}' GHz**\n"
